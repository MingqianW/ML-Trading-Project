...
np.save('LSTM\X_train.npy', X_train)
np.save('LSTM\X_val.npy', X_val)
np.save('LSTM\X_test.npy', X_test)
np.save('LSTM\y_train.npy', y_train)
np.save('LSTM\y_val.npy', y_val)
np.save('LSTM\y_test.npy', y_test)
